...
<head>
  <!-- github-pages cache clear Meta Tags -->
  ...
  <title>Migas - Renewable Energy </title>
  <meta name="description" content="Migas offers eco-friendly solutions">
  <meta name="author" content="JeremiahGeorge">
...
<body data-bs-spy="scroll" data-bs-target="#bsb-tpl-navbar" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <nav id="scrollspyNav" class="navbar navbar-expand-lg bsb-tpl-bg-blue bsb-navbar bsb-navbar-hover bsb-navbar-caret bsb-tpl-navbar-sticky" data-bsb-sticky-target="#header">
      <div class="container">
        <a class="navbar-brand" href="index.html">
          <img src="./assets/img/branding/migas_logo.png" class="bsb-tpl-logo" alt="">
        </a>
    ...
    <div class="container overflow-hidden">
      <div class="row gy-3 gy-lg-0 align-items-lg-center justify-content-lg-between">
        <div class="col-12 col-lg-6 order-1 order-lg-0" >
          <h1 class="display-3 fw-bolder mb-3">Get cost-effective<br><mark class="bsb-tpl-highlight bsb-tpl-highlight-green"><span class="bsb-tpl-font-hw display-2 text-accent fw-normal">biogas energy</span></mark> tailored to your needs and budget.</h1>
          <p class="fs-4 mb-5">We offer negotiable biogas bioreactor installation with the use of local available construction materials.</p>
          <div class="d-grid gap-2 d-sm-flex">
            <button type="button" class="btn btn-primary bsb-btn-3xl rounded-pill">Free Consultation</button>
            <button type="button" class="btn btn-outline-primary bsb-btn-3xl rounded-pill">Portfolio</button>
          </div>
        </div>
        <div class="col-12 col-lg-5 text-center">
          <svg class="img-fluid" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
            <image xlink:href="./assets/img/hero/biogas.jpg" width="100" height="100" />
          </svg>
        </div>
  ...
  <main id="main">
        ...
        <div class="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
          <div class="col-11 col-sm-6 col-lg-3">
            <div class="badge bsb-tpl-bg-yellow text-primary p-3 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-border-middle" viewBox="0 0 16 16">
                <path d="M7.5 1.018a7 7 0 0 0-4.79 11.566L7.5 7.793V1.018zm1 0V7.5h6.482A7.001 7.001 0 0 0 8.5 1.018zM14.982 8.5H8.207l-4.79 4.79A7 7 0 0 0 14.982 8.5zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z" />
              </svg>
            </div>
            <h4 class="mb-3">Biogas system installation</h4>
            <p class="mb-3 text-secondary">Expert installation of biogas systems tailored to your specific requirements, ensuring efficient energy production from organic waste.</p>
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Bioseptic services</h4>
            <p class="mb-3 text-secondary">Routine inspection and servicing of bioseptic systems to enhance functionality and guarantee sustained dependability, reducing operational interruptions and maximizing waste treatment efficiency.</p>
            <!-- <a href="#!" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Thermal systems</h4>
            <p class="mb-3 text-secondary">Regular maintenance and monitoring of thermal systems to optimize efficiency and ensure long-term reliability, minimizing operational disruptions and maximizing heat output.</p>
            <!-- <a href="#!" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
          ...
          <div class="col-11 col-sm-6 col-lg-3">
            ...
            <h4 class="mb-3">Solar services</h4>
            <p class="mb-3 text-secondary">Consistent inspection and cleaning of solar panels to maximize energy absorption and ensure sustained performance, reducing downtime and enhancing overall power generation.</p>
            <!-- <a href="#!" class="fw-bold text-decoration-none link-primary">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
    ...
    <section class="bsb-cta-1 px-2 bsb-overlay" style="background-image: url('./assets/img/portfolio/bioGas.jpeg');">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-9 col-lg-8 col-xl-8 col-xxl-7">
            <h3 class="fs-5 mb-3 text-white text-uppercase"><mark class="text-white bsb-tpl-highlight">Unlock Clean Energy</mark></h3>
            <h2 class="display-3 text-white fw-bolder mb-4 pe-xl-5">Contact us for free consultation and learn how Mygas can power your home with clean energy.</h2>
            <a href="#scrollspyContact" class="btn btn-accent bsb-btn-3xl rounded mb-0 text-nowrap">Contact Us</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="scrollspyPortfolio" class="py-5 py-xl-8 bsb-section-py-xxl-1">
      <div class="container mb-5 mb-md-6 mb-xl-10">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 class="display-3 fw-bolder mb-4">Meet our portfolio to <br><mark class="bsb-tpl-highlight bsb-tpl-highlight-yellow"><span class="bsb-tpl-font-hw display-1 text-nowrap fw-normal">kickstart</span></mark> your success.</h2>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-2 g-md-2 g-xl-3 bsb-project-2-grid">
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" src="./assets/img/portfolio/bioGas.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInLeft">Green solutions</h3>
                <div class="text-white bsb-hover-fadeInRight">Earth-friendly Options</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/hero/biogas.jpg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Ecofuel Assortment</h3>
                <div class="text-white bsb-hover-fadeInDown">Biofuel Range</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" src="./assets/img/hero/biogas.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInLeft">Biogas Catalog</h3>
                <div class="text-white bsb-hover-fadeInRight">Clean Energy Selection</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/portfolio/sept.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Biodigester</h3>
                <div class="text-white bsb-hover-fadeInDown">We do toilet Biodigester at a Friendly Price</div>
              </figcaption>
            </figure> 
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/hero/bio_gas.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Renewable Suite</h3>
                <div class="text-white bsb-hover-fadeInDown">Eco Assets</div>
              </figcaption>
            </figure>         
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale bsb-hover-scale-up" src="./assets/img/portfolio/bioGas.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInUp">Organic Energy</h3>
                <div class="text-white bsb-hover-fadeInDown">Biogas Varieties</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" src="./assets/img/portfolio/bolts_box.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInLeft">Eco-Friendly Choices</h3>
                <div class="text-white bsb-hover-fadeInRight">Green Power Options</div>
              </figcaption>
            </figure>
          </div>
          ...
          <div class="col-12 col-md-4 bsb-project-2-item">
            <figure class="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
              <a href="#!">
                <img class="img-fluid bsb-scale-up bsb-hover-scale" src="./assets/img/portfolio/bolts.jpeg" alt="">
              </a>
              <figcaption>
                <h3 class="text-white bsb-hover-fadeInLeft">charcoal-Briquettes</h3>
                <div class="text-white bsb-hover-fadeInRight">Reach out for Eco-Friendly charcoal-Briquettes</div>
              </figcaption>
            </figure>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row gy-5 gy-lg-0 align-items-lg-center">
          <div class="col-12 col-lg-6">
            <img class="img-fluid rounded" loading="lazy" src="./assets/img/hero/biogas.jpeg" alt="">
          </div>
          <div class="col-12 col-lg-6">
            <div class="row justify-content-xl-end">
              <div class="col-12 col-xl-11">
                <h2 class="display-3 fw-bolder mb-4">Our <mark class="bsb-tpl-highlight bsb-tpl-highlight-top"><span class="bsb-tpl-font-hw display-1 text-accent fw-normal">forward-thinking</span></mark><br> approach will let you prefer us.</h2>
                <p class="fs-4 mb-5">Discover the reasons behind our unrivaled appeal.</p>

                <div class="accordion accordion-flush" id="accordionExample">
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingOne">
                      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        Affordable Bio-gas Energy
                      </button>
                    </h2>
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        Mygas is a company that emerges to avail affordable biogas energy through negotiations and pocket friendly solutions to each client need and ability.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        Negotiable biogas bioreactor installation
                      </button>
                    </h2>
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        We offer negotiable biogas bioreactor installation with the use of local available construction materials.
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        To ensure we give everyone opportunity, we are willing to listen to your wishes and see your comfortable plans to own biogas.
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  ...
                  <figcaption>
                    ...
                    <blockquote class="bsb-blockquote-icon mb-4">I'm impressed by the affordability and environmental benefits of Mygas biogas. Highly recommended!</blockquote>
                    <h4 class="mb-2">Kabi John</h4>
              ...
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  ...
                  <figcaption>
                    ...
                    <blockquote class="bsb-blockquote-icon mb-4">Switching to Mygas has been a great decision. It's good for the environment and my wallet.</blockquote>
                    <h4 class="mb-2">Mark Mwakarime</h4>
                    <h5 class="fs-6 text-secondary mb-0">Kilifi Resident</h5>
                  </figcaption>
                </figure>
              </div>
            </div>
            ...
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body p-4 p-xxl-5">
                <figure>
                  ...
                  <figcaption>
                    <div class="bsb-ratings text-warning mb-3" data-bsb-star="5" data-bsb-star-off="0"></div>
                    <blockquote class="bsb-blockquote-icon mb-4">Mygas provides reliable energy and their customer service is excellent.Great Choice.</blockquote>
                    <h4 class="mb-2">Luke Omondi</h4>
                    <h5 class="fs-6 text-secondary mb-0">Cook</h5>
                  </figcaption>
                </figure>
              </div>
            </div>
              ...
              <div class="col-12 col-xl-11">
                ...
                <div class="d-flex mb-4">
                  ...
                  <div>
                    ...
                    <address class="mb-0 text-secondary">Kilifi, Kenya</address>
                  </div>
                </div>
                <div class="d-flex mb-4">
                  <div class="me-4 text-primary">
      ...
      <div class="container overflow-hidden">
        <div class="row gy-4 gy-lg-0 justify-content-xl-between">
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              <a href="#!">
                <img src="./assets/img/branding/migas_logo.png" alt="" class="bsb-tpl-logo-footer">
              </a>
            </div>
          </div>
          <div class="col-12 col-md-4 col-lg-3 col-xl-2">
            <div class="widget">
              ...
              <address class="mb-4">Kilifi, Kenya</address>
              <p class="mb-1">
                <a class="link-secondary text-decoration-none" href="tel:+254756713646">(254) 756-713-646</a>
              </p>
              <p class="mb-0">
        ...
        <div class="row gy-4 gy-md-0">
          <div class="col-xs-12 col-md-7 order-1 order-md-0">
            ...
            <div class="credits text-secondary text-center text-md-start mt-2 fs-7">
              Built by <a href="https://linkedin.com/in/jeremiah-george/" class="link-secondary text-decoration-none" target="_blank" rel="noopener noreferrer">JG</a> with <span class="text-primary">&#9829;</span>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-md-5 order-0 order-md-1">
            <ul class="nav justify-content-center justify-content-md-end">
              <li class="nav-item">
                <a class="nav-link link-dark" href="https://www.facebook.com/profile.php?id=61557128952084" target="_blank">
              ...
              <li class="nav-item">
                <a class="nav-link link-dark" href=https://www.youtube.com/@blessedemmanuel254" target="_blank"><i class="fa-brands fa-youtube>
